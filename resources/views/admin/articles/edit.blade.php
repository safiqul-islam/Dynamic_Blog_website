            ...
            <div class="row">
                <div class="col-md-10 mx-auto">
                    <div class="card bg-gray-500">
                        ...
                        <div class="card-body">
                            <form action="{{ route('articles.update',$blog->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="article_title" class="form-control" value="{{ $blog->article_title }}">
                                    </div>
                                </div>
